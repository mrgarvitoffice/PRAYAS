    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-indigo-600 dark:bg-indigo-900 overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 p-12 text-center max-w-lg">
          ...
          <h1 className="text-4xl font-bold text-white mb-6 tracking-tight">Prayas News Terminal</h1>
          <p className="text-indigo-100 text-lg leading-relaxed">
            Your personalized, AI-powered daily briefing for current affairs. 
            Join our community of learners and stay ahead of the curve.
          </p>
        </div>
      </div>
